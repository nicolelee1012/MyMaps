...
import com.example.mymaps2.databinding.ActivityCreateMapBinding
import com.example.mymaps2.models.Place
...
class CreateMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.setOnInfoWindowClickListener { markerToDelete ->
            Log.i(TAG, "onWIndowClickListener - delte this marker")
        ...
        val silliconValley = LatLng(37.4, -122.1)
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(silliconValley, 10f))
    }
